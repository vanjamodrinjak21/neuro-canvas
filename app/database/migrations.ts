/**
 * SQLite Migration System for NeuroCanvas
 *
 * Manages schema versioning for Tauri (tauri-plugin-sql) and
 * Capacitor (@capacitor-community/sqlite) native databases.
 */
...
/**
 * All migrations in order. Each migration's SQL is idempotent
...
/** Returns the SQL for all migrations not yet applied */
