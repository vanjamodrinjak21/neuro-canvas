...
const canSubmit = computed(() => email.value && password.value && isEmailValid.value && !isLoading.value)
...
async function handleSignin() {
  ...
  try {
    ...
    if (result?.error) {
      message.value = result.error === 'CredentialsSignin' ? 'Invalid email or password' : result.error
      messageType.value = 'error'
  ...
  <div class="auth-page">
    ...
    <div class="brand-panel">
      ...
      <div class="brand-content">
        <h1 class="brand-headline">Map your thoughts,<br>discover connections.</h1>
        <p class="brand-desc">Join thousands of students and researchers using AI-powered mind mapping to organize knowledge and learn faster.</p>
      </div>

      <div class="testimonial">
        <p class="testimonial-quote">"NeuroCanvas changed how I study. The AI suggestions helped me connect concepts I never would have linked on my own."</p>
        <div class="testimonial-author">
          <div class="author-avatar">
            <span>AK</span>
          </div>
          <div class="author-info">
            <span class="author-name">Ana Kovačević</span>
            <span class="author-role">Cognitive Science, University of Zagreb</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="form-panel">
      <div class="form-container">
        <div class="form-header">
          ...
          <p class="form-subtitle">Sign in to continue to your maps</p>
        </div>
        ...
        <div class="oauth-buttons">
          <button class="oauth-btn" :disabled="isGoogleLoading || isGithubLoading" @click="handleGoogleSignin">
            ...
            <span class="i-lucide-loader-2 animate-spin" v-else />
        ...
        <form class="fields" @submit.prevent="handleSignin">
          ...
          <div class="field">
            <div class="field-label-row">
              ...
              <NuxtLink to="#" class="forgot-link">Forgot password?</NuxtLink>
            </div>
